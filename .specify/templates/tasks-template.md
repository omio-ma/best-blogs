...
**Tests**: The examples below include test tasks. Per the constitution's Test-Required Development principle, contract and integration tests are MANDATORY for all features. Unit tests are recommended but optional.
